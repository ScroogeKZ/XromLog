...
export default function TrackOrder() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'new': return '!bg-blue-100 !text-blue-800 border-blue-200 dark:!bg-blue-900 dark:!text-blue-200';
      case 'processing': return '!bg-yellow-100 !text-yellow-800 border-yellow-200 dark:!bg-yellow-900 dark:!text-yellow-200';
      case 'assigned': return '!bg-purple-100 !text-purple-800 border-purple-200 dark:!bg-purple-900 dark:!text-purple-200';
      case 'transit': return '!bg-orange-100 !text-orange-800 border-orange-200 dark:!bg-orange-900 dark:!text-orange-200';
      case 'delivered': return '!bg-green-100 !text-green-800 border-green-200 dark:!bg-green-900 dark:!text-green-200';
